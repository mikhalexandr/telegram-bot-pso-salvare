...
def create_form(lost_name_id, born, regions, description, feature, spec_feature, clothes, items, photo):
    ...
    font = ImageFont.truetype("assets/fonts/calibri.ttf", 50)
    ...
    font = ImageFont.truetype("assets/fonts/calibri.ttf", 25)
    ...
    font = ImageFont.truetype("assets/fonts/calibri.ttf", 35)
    ...
    os.remove(f"assets/temporary/photo{photo}.jpg")
    return result
